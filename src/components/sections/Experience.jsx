...
const Experience = () => {
  return (
    <section id="experience" className="py-20 relative bg-slate-100/50 dark:bg-dark-card/30">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-display font-bold mb-4">Professional <span className="text-gradient">Experience</span></h2>
          ...
          {experienceData.map((item, index) => (
            ...
            >
              ...
              <div className="glass p-8 rounded-2xl hover:-translate-y-1 transition-transform duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-2">{item.role}</h3>
                <h4 className="text-lg text-slate-600 dark:text-slate-400 mb-4 font-medium">{item.company}</h4>
